        ...
        <div className="sidebar-inner slimscroll">
          <div className="sidebar-menu">
            <ul>
              ...
              <li> 
                <a href="/dark/tasks/tasks">Project Management</a>
              </li>
              <li className="active"> 
                <a href="/dark/tasks/tasks">Hospital Administration</a>
              </li>
              <li> 
                <a href="/dark/tasks/tasks">Video Calling App</a>
              </li>
              <li> 
                <a href="/dark/tasks/tasks">Office Management</a>
              </li>
            </ul>
          </div>
        </div>
