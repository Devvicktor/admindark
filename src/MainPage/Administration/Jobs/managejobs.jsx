   ...
   render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'jobtitle',
        render: (text, record) => (            
            <a href="/dark/app/administrator/job-details">{text}</a>
          ), 
      ...
      },
      {
        ...
        render: (text, record) => (
          <a href="/dark/app/administrator/job-applicants" className="btn btn-sm btn-primary">{text}</a>
          ),
            ...
            <div className="table-responsive">
              ...
              {/* <table className="table table-striped custom-table mb-0 datatable">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td><a href="/dark/app/administrator/job-details">Web Developer</a></td>
                    <td>Development</td>
                    <td>3 Mar 2019</td>
                    <td>31 May 2019</td>
                    ...
                    <td><a href="/dark/app/administrator/job-applicants" className="btn btn-sm btn-primary">3 Candidates</a></td>
                  ...
                  <tr>
                    <td>2</td>
                    <td><a href="/dark/app/administrator/job-details">Web Designer</a></td>
                    <td>Designing</td>
                    <td>3 Mar 2019</td>
                    <td>31 May 2019</td>
                    <td className="text-center">
                    ...
                    <td><a href="/dark/app/administrator/job-applicants" className="btn btn-sm btn-primary">2 Candidates</a></td>
                    <td className="text-right">
                      <div className="dropdown dropdown-action">
                        <a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_vert</i></a>
                        <div className="dropdown-menu dropdown-menu-right">
                  ...
                  <tr>
                    <td>3</td>
                    <td><a href="/dark/app/administrator/job-details">Android Developer</a></td>
                    <td>Android</td>
                    <td>3 Mar 2019</td>
                    <td>31 May 2019</td>
                    <td className="text-center">
                    ...
                    <td><a href="/dark/app/administrator/job-applicants" className="btn btn-sm btn-primary">1 Candidates</a></td>
                    <td className="text-right">
                      <div className="dropdown dropdown-action">
                        <a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_vert</i></a>
                        <div className="dropdown-menu dropdown-menu-right">
