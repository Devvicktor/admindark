                ...
                <div className="navbar">
                  <div className="user-details mr-auto">
                    <div className="float-left user-img">
                      <a className="avatar" href="/dark/app/profile/employee-profile" title="Mike Litorus">
                        <img src={Avatar_05} alt="" className="rounded-circle" />
                        <span className="status online" />
                      </a>
                    </div>
                    <div className="user-info float-left">
                      <a href="/dark/app/profile/employee-profile" title="Mike Litorus"><span>Mike Litorus</span> <i className="typing-text">Typing...</i></a>
                  ...
                  <ul className="nav custom-menu">
                    ...
                    <li className="nav-item">
                      <a href="/dark/conversation/voice-call" className="nav-link"><i className="fa fa-phone" /></a>
                    </li>
                    <li className="nav-item">
                      <a href="/dark/conversation/video-call" className="nav-link"><i className="fa fa-video-camera" /></a>
                    </li>
                      ...
                      <div className="chats">
                        ...
                        <div className="chat chat-left">
                          <div className="chat-avatar">
                            <a href="/dark/app/profile/employee-profile" className="avatar">
