         ...
         <div >
          ...
          <div className="header">
            ...
            <div className="header-left">
              <a href="/dark/app/main/dashboard" className="logo">
            ...
            <ul className="nav user-menu">
              ...
              <li className="nav-item">
                <div className="top-nav-search">
                  ...
                  <form action="/dark/app/pages/search">
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu notifications">
                  ...
                  <div className="noti-content">
                    <ul className="notification-list">
                      <li className="notification-message">
                        <a href="/dark/app/administrator/activities">
                          <div className="media">
                  ...
                  <div className="topnav-dropdown-footer">
                    <a href="/dark/app/administrator/activities">View all Notifications</a>
                  </div>
                </div>
              </li>
              {/* /Notifications */}
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu notifications">
                  ...
                  <div className="topnav-dropdown-footer">
                    <a href="/dark/conversation/chat">View all Messages</a>
                  </div>
                </div>
              </li>
              {/* /Message Notifications */}
              <li className="nav-item dropdown has-arrow main-drop">
                ...
                <div className="dropdown-menu">
                  <a className="dropdown-item" href="/dark/app/profile/employee-profile">My Profile</a>
                  <a className="dropdown-item" href="/dark/settings/companysetting">Settings</a>
                  <a className="dropdown-item" href="/dark/login">Logout</a>
                </div>
              </li>
            </ul>
            {/* /Header Menu */}
