              ...
              {/* <table className="table table-striped custom-table mb-0 datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>5 Jan 2019</td>
                    <td>
                      <a href="/dark/app/profile/employee-profile" className="avatar avatar-xs">
                        <img src={Avatar_04} alt="" />
                      </a>
                      <h2><a href="/dark/app/profile/employee-profile">Loren Gatlin</a></h2>
                    </td>
                    <td>$ 1215</td>
                    <td>Cash</td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <h2><a href="/dark/app/profile/employee-profile">Tarah Shropshire</a></h2>
                    </td>
                    <td>$ 1215</td>
                    <td>Cheque</td>
                    <td className="text-center">
